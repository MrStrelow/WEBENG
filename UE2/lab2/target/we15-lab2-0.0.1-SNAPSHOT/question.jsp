      ...
      <section id="question" aria-labelledby="questionheading">
            <form id="questionform" action="QuestionServlet" method="get">
               ...
               <ul id="answers">
                  ...
                  <li><input name="answers" id="answer_4" value="Was ist Objektorientierte Modellierung?" type="checkbox"/><label class="tile clickable" for="answer_4">Was ist Objektorientierte Modellierung?</label></li>
               </ul>
