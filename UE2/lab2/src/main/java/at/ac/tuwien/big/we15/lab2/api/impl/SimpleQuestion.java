/**
 * <copyright> Copyright (c) 2014 http://www.big.tuwien.ac.at All rights reserved. This program and the accompanying materials are made available under the terms of the Eclipse Public License v1.0 which
...
public class SimpleQuestion implements Question {
    ...
    public SimpleQuestion(int id, String text, int value, List<Answer> wrongChoices, List<Answer> correctChoices, Category category) {
        super();
        this.id = id;
        this.text = text;
        this.value = value;
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + ((rightAnswers == null) ? 0 : rightAnswers.hashCode());
    ...
    public boolean equals(Object obj) {
        ...
        if (rightAnswers == null) {
            if (other.rightAnswers != null) return false;
        } else if (!rightAnswers.equals(other.rightAnswers)) return false;
        if (value != other.value) return false;
        if (text == null) {
            if (other.text != null) return false;
        } else if (!text.equals(other.text)) return false;
        if (wrongAnswers == null) {
            if (other.wrongAnswers != null) return false;
        } else if (!wrongAnswers.equals(other.wrongAnswers)) return false;
        return true;
    }

    @Override
    public String toString() {
        return "SimpleQuestion [value=" + value + ", text=" + text + ", wrongChoices=" + wrongAnswers + ", correctChoices=" + rightAnswers + ", category=" + ((category != null) ? category.getName() :
                "null") + "]";
    }
