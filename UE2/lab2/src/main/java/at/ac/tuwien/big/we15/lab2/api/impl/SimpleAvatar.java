...
public enum SimpleAvatar implements Avatar {
    ...
    static {
        for (Avatar avatar : SimpleAvatar.values())
    ...
    SimpleAvatar(String id, String name, boolean isVillain) {
        this.id = id;
        this.name = name;
    ...
    public static Avatar getOpponent(Avatar avatar) {
        ...
        while (opponent.isVillain() == avatar.isVillain()) opponent = getRandomAvatar();
        return opponent;
    }
