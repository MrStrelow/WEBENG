...
public class Client {
    ...
    /**
     * Contains the messages wich are buffered until the previous send operation has finished.
     */
    ...
    /**
     * If this client is closing. If <code>true</code>, new messages to send will be ignored.
     */
    private volatile boolean isClosing = false;
    /**
     * The length of all current buffered messages, to avoid iterating over a linked list.
     */
