...
/**
 * This doesn't do anything particularly useful - it just writes a series of numbers to the response body while demonstrating how to perform non-blocking writes.
 */
public class NumberWriter extends HttpServlet {
    ...
    private static class NumberWriterListener implements ReadListener, WriteListener {
        ...
        private NumberWriterListener(AsyncContext ac, ServletInputStream sis, ServletOutputStream sos) {
            this.ac = ac;
            this.sis = sis;
            this.sos = sos;
